...
$ronin_audio_url = function_exists( 'tpmeta_field' ) ? tpmeta_field( 'ronin_post_audio' ) : NULL;
...
<div id="post-<?php the_ID();?>" <?php post_class( 'blog-post-details format-image');?>>
    <div class="single-blog-post">
        ...
        <div class="post-featured-thumb ">
            <?php echo wp_oembed_get( $ronin_audio_url ); ?>
        </div>
        <?php endif;?>
...
<div id="post-<?php the_ID();?>" <?php post_class( 'news-standard-items format-audio' );?>>
