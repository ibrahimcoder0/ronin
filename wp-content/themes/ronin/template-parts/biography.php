<?php
    ...
    $author_info = get_the_author_meta( 'ronin_write_by');
    $facebook_url = get_the_author_meta( 'ronin_facebook' );
    $twitter_url = get_the_author_meta( 'ronin_twitter' );
    $linkedin_url = get_the_author_meta( 'ronin_linkedin' );
    $instagram_url = get_the_author_meta( 'ronin_instagram' );
    $ronin_url = get_the_author_meta( 'ronin_youtube' );
    $ronin_write_by = get_the_author_meta( 'ronin_write_by' );
