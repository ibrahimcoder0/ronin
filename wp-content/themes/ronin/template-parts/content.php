...
$social_shear_col= $ronin_singleblog_social ? "col-xl-6 col-lg-6 col-md-6" : "col-xl-12 col-md-12 col-lg-12";
...
<div id="post-<?php the_ID();?>" <?php post_class( 'news-standard-items format-standard' );?>>
